...
/// RAII-style owner of the private aggregate device that contains the system
/// audio tap as an input and the physical output device as an output subdevice
/// (spec §9).
...
final class AggregateDeviceHandle {
    ...
    init(outputDeviceUID: String, tapUID: String) throws {
        ...
        let description: [String: Any] = [
            kAudioAggregateDeviceNameKey: "De-Esser",
