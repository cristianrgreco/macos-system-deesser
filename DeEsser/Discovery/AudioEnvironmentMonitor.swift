...
final class AudioEnvironmentMonitor {
    ...
    func startSystemListeners() {
        // System-wide de-essing follows the default output device; the set of
        // audio-producing processes no longer affects the graph, so we do not
        // listen on the process-object list.
